...
namespace Sentez.EgeHayatVehicleFleetManagementModule.PresentationModels
{
    public class EgeHayatVehicleFleetManagementModuleParametersPM : PMDesktop
    {
        ...
        EgeHayatVehicleFleetManagementModuleParameters parameters;
        public EgeHayatVehicleFleetManagementModuleParameters Parameters
        {
        ...
        public EgeHayatVehicleFleetManagementModuleParametersPM(IContainerExtension container)
            : base(container)
        {
            Parameters = ActiveSession.ParamService.GetParameterClass<EgeHayatVehicleFleetManagementModuleParameters>();
        }

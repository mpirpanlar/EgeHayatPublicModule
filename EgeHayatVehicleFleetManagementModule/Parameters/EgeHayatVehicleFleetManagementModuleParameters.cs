...
namespace Sentez.EgeHayatVehicleFleetManagementModule.Parameters
{
    public class EgeHayatVehicleFleetManagementModuleParameters : ParameterBase
    {
        ...
        public EgeHayatVehicleFleetManagementModuleParameters()
            : base()
        {
        ...
        {
            return new EgeHayatVehicleFleetManagementModuleParameters();
        }
    }
}

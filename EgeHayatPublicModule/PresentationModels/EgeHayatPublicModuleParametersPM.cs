...
namespace Sentez.EgeHayatPublicModule.PresentationModels
{
    public class EgeHayatPublicModuleParametersPM : PMDesktop
    {
        ...
        EgeHayatPublicModuleParameters parameters;
        public EgeHayatPublicModuleParameters Parameters
        {
        ...
        public EgeHayatPublicModuleParametersPM(IContainerExtension container)
            : base(container)
        {
            Parameters = ActiveSession.ParamService.GetParameterClass<EgeHayatPublicModuleParameters>();
        }

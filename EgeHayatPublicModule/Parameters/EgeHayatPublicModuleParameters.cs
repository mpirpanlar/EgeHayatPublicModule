...
namespace Sentez.EgeHayatPublicModule.Parameters
{
    public class EgeHayatPublicModuleParameters : ParameterBase
    {
        ...
        public EgeHayatPublicModuleParameters()
            : base()
        {
        ...
        {
            return new EgeHayatPublicModuleParameters();
        }
    }
}

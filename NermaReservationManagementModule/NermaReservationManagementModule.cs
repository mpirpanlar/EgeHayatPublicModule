...
using Sentez.NermaReservationManagementModule.Services;
using System;
using System.IO;
using System.Reflection;
using NermaReservationManagementModule.Services;
using Sentez.Common.PresentationModels;
using Sentez.NermaReservationManagementModule.Models;
using Sentez.Common.Utilities;
using Sentez.NermaReservationManagementModule.WorkList;
...
namespace Sentez.NermaReservationManagementModule
{
    public partial class NermaReservationManagementModule : LiveModule
    {
        ...
        private void RegisterViews()
        {
            ...
            ResMng.AddRes("InventoryUnitItemSizeSetDetailsView", "NermaReservationManagementModule;component/Views/InventoryUnitItemSizeSetDetails.xaml", ResSource.Resource, ResourceType.View, Modules.ExternalModule15, 0, 0);
            ...
            ResMng.AddRes("InventoryPriceListDetailsView", "NermaReservationManagementModule;component/Views/InventoryPriceListDetails.xaml", ResSource.Resource, ResourceType.View, Modules.ExternalModule15, 0, 0);

            ResMng.AddRes("CategoryUnitItemSizeSetDetailsView", "NermaReservationManagementModule;component/Views/CategoryUnitItemSizeSetDetails.xaml", ResSource.Resource, ResourceType.View, Modules.ExternalModule15, 0, 0);

            ResMng.AddRes("InventoryMarksView", "NermaReservationManagementModule;component/Views/InventoryMarks.xaml", ResSource.Resource, ResourceType.View, Modules.ExternalModule15, 0, 0);
            ResMng.AddRes("VariantItemMarksView", "NermaReservationManagementModule;component/Views/VariantItemMarks.xaml", ResSource.Resource, ResourceType.View, Modules.ExternalModule15, 0, 0);

            ResMng.AddRes("AttributeSetDetailsView", "NermaReservationManagementModule;component/Views/AttributeSetDetails.xaml", ResSource.Resource, ResourceType.View, Modules.ExternalModule15, 0, 0);
            ResMng.AddRes("CategoryAttributeSetDetailsView", "NermaReservationManagementModule;component/Views/CategoryAttributeSetDetails.xaml", ResSource.Resource, ResourceType.View, Modules.ExternalModule15, 0, 0);

            ResMng.AddRes("QuotationRecipeItemView", "NermaReservationManagementModule;component/Views/QuotationRecipeItem.xaml", ResSource.Resource, ResourceType.View, Modules.ExternalModule15, 0, 0);
            ResMng.AddRes("OrderRecipeItemView", "NermaReservationManagementModule;component/Views/OrderRecipeItem.xaml", ResSource.Resource, ResourceType.View, Modules.ExternalModule15, 0, 0);
        }

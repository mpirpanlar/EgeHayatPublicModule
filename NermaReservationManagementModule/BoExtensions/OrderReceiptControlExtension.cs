...
namespace NermaReservationManagementModule.BoExtensions
{
    public class OrderReceiptControlExtension : BoExtensionBase
    {
        ...
        protected override void OnBeforePost(object sender, CancelEventArgs e)
        {
            ...
            if (!e.Cancel)
            {
                foreach (DataRow itemRow in BusinessObject.Data.Tables["Erp_OrderReceiptItem"].Select("", "", DataViewRowState.CurrentRows))
                {
